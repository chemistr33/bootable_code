...
void
task_save_state (struct task *task, struct interrupt_frame *frame)
{
...
int
copy_string_from_task (struct task *task, void *virtual, void *phys, int max)
{
